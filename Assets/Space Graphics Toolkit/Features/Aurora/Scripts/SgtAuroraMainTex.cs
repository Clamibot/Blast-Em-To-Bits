...
namespace SpaceGraphicsToolkit
{
	...
	public class SgtAuroraMainTex : MonoBehaviour
	{
		...
		public int Height { set { if (height != value) { height = value; UpdateTexture(); } } get { return height; } } [FSA("Height")] [SerializeField] private int height = 64;
		...
		public float NoiseStrength { set { if (noiseStrength != value) { noiseStrength = value; UpdateTexture(); } } get { return noiseStrength; } } [FSA("NoiseStrength")] [SerializeField] [Range(0.0f, 1.0f)] private float noiseStrength = 0.75f;

		/// <summary>The amount of noise points.</summary>
		public int NoisePoints { set { if (noisePoints != value) { noisePoints = value; UpdateTexture(); } } get { return noisePoints; } } [FSA("NoisePoints")] [SerializeField] private int noisePoints = 30;

		/// <summary>The random seed used when generating this texture.</summary>
		public int NoiseSeed { set { if (noiseSeed != value) { noiseSeed = value; UpdateTexture(); } } get { return noiseSeed; } } [FSA("NoiseSeed")] [SerializeField] [SgtSeed] private int noiseSeed;

		/// <summary>The transition style between the top and middle.</summary>
		public SgtEase.Type TopEase { set { if (topEase != value) { topEase = value; UpdateTexture(); } } get { return topEase; } } [FSA("TopEase")] [SerializeField] private SgtEase.Type topEase = SgtEase.Type.Quintic;

		/// <summary>The transition strength between the top and middle.</summary>
		public float TopSharpness { set { if (topSharpness != value) { topSharpness = value; UpdateTexture(); } } get { return topSharpness; } } [FSA("TopSharpness")] [SerializeField] private float topSharpness = 1.0f;

		/// <summary>The point separating the top from bottom.</summary>
		public float MiddlePoint { set { if (middlePoint != value) { middlePoint = value; UpdateTexture(); } } get { return middlePoint; } } [FSA("MiddlePoint")] [SerializeField] [Range(0.0f, 1.0f)] private float middlePoint = 0.25f;

		/// <summary>The base color of the aurora starting from the bottom.</summary>
		public Color MiddleColor { set { if (middleColor != value) { middleColor = value; UpdateTexture(); } } get { return middleColor; } } [FSA("MiddleColor")] [SerializeField] private Color middleColor = Color.green;

		/// <summary>The transition style between the bottom and top of the aurora.</summary>
		public SgtEase.Type MiddleEase { set { if (middleEase != value) { middleEase = value; UpdateTexture(); } } get { return middleEase; } } [FSA("MiddleEase")] [SerializeField] private SgtEase.Type middleEase = SgtEase.Type.Exponential;

		/// <summary>The strength of the color transition between the bottom and top.</summary>
		public float MiddleSharpness { set { if (middleSharpness != value) { middleSharpness = value; UpdateTexture(); } } get { return middleSharpness; } } [FSA("MiddleSharpness")] [SerializeField] private float middleSharpness = 3.0f;

		/// <summary>The transition style between the bottom and middle.</summary>
		public SgtEase.Type BottomEase { set { if (bottomEase != value) { bottomEase = value; UpdateTexture(); } } get { return bottomEase; } } [FSA("BottomEase")] [SerializeField] private SgtEase.Type bottomEase = SgtEase.Type.Exponential;

		/// <summary>The transition strength between the bottom and middle.</summary>
		public float BottomSharpness { set { if (bottomSharpness != value) { bottomSharpness = value; UpdateTexture(); } } get { return bottomSharpness; } } [FSA("BottomSharpness")] [SerializeField] private float bottomSharpness = 1.0f;
	...
	public class SgtAuroraMainTex_Editor : SgtEditor<SgtAuroraMainTex>
	{
		protected override void OnInspector()
		{
			BeginError(Any(t => t.Width < 1));
				Draw("width", "The width of the generated texture. A higher value can result in a smoother transition. This stores the noise samples.");
			EndError();
			BeginError(Any(t => t.Height < 1));
				Draw("height", "The height of the generated texture. A higher value can result in a smoother transition. This stores the vertical color samples.");
			EndError();
			Draw("format", "The format of the generated texture.");

			Separator();

			Draw("noiseStrength", "The strength of the noise points.");
			BeginError(Any(t => t.NoisePoints <= 0));
				Draw("noisePoints", "The amount of noise points.");
			EndError();
			Draw("noiseSeed", "The random seed used when generating this texture.");

			Separator();

			Draw("topEase", "The transition style between the top and middle.");
			Draw("topSharpness", "The transition strength between the top and middle.");

			Separator();

			Draw("middlePoint", "The point separating the top from bottom.");
			Draw("middleColor", "The base color of the aurora starting from the bottom.");
			Draw("middleEase", "The transition style between the bottom and top of the aurora.");
			Draw("middleSharpness", "The strength of the color transition between the bottom and top.");

			Separator();

			Draw("bottomEase", "The transition style between the bottom and middle.");
			Draw("bottomSharpness", "The transition strength between the bottom and middle.");
		}
	}
}
#endif