...
namespace SpaceGraphicsToolkit
{
	...
	public class SgtJovianScatteringTex : MonoBehaviour
	{
		...
		public int Width { set { if (width != value) { width = value; UpdateTexture(); } } get { return width; } } [FSA("Width")] [SerializeField] private int width = 64;

		/// <summary>The resolution of the scattering transition in pixels.</summary>
		public int Height { set { if (height != value) { height = value; UpdateTexture(); } } get { return height; } } [FSA("Height")] [SerializeField] private int height = 512;
		...
		public float Mie { set { if (mie != value) { mie = value; UpdateTexture(); } } get { return mie; } } [FSA("Mie")] [SerializeField] private float mie = 150.0f;

		/// <summary>The brightness of the front and back scattered light.</summary>
		public float Rayleigh { set { if (rayleigh != value) { rayleigh = value; UpdateTexture(); } } get { return rayleigh; } } [FSA("Rayleigh")] [SerializeField] private float rayleigh = 0.1f;

		/// <summary>The transition style between the day and night.</summary>
		public SgtEase.Type SunsetEase { set { if (sunsetEase != value) { sunsetEase = value; UpdateTexture(); } } get { return sunsetEase; } } [FSA("SunsetEase")] [SerializeField] private SgtEase.Type sunsetEase = SgtEase.Type.Smoothstep;

		/// <summary>The start point of the sunset (0 = dark side, 1 = light side).</summary>
		public float SunsetStart { set { if (sunsetStart != value) { sunsetStart = value; UpdateTexture(); } } get { return sunsetStart; } } [FSA("SunsetStart")] [SerializeField] [Range(0.0f, 1.0f)] private float sunsetStart = 0.4f;

		/// <summary>The end point of the sunset (0 = dark side, 1 = light side).</summary>
		public float SunsetEnd { set { if (sunsetEnd != value) { sunsetEnd = value; UpdateTexture(); } } get { return sunsetEnd; } } [FSA("SunsetEnd")] [SerializeField] [Range(0.0f, 1.0f)] private float sunsetEnd = 0.6f;

		/// <summary>The sharpness of the sunset red channel transition.</summary>
		public float SunsetSharpnessR { set { if (sunsetSharpnessR != value) { sunsetSharpnessR = value; UpdateTexture(); } } get { return sunsetSharpnessR; } } [FSA("SunsetSharpnessR")] [SerializeField] private float sunsetSharpnessR = 1.0f;

		/// <summary>The sharpness of the sunset green channel transition.</summary>
		public float SunsetSharpnessG { set { if (sunsetSharpnessG != value) { sunsetSharpnessG = value; UpdateTexture(); } } get { return sunsetSharpnessG; } } [FSA("SunsetSharpnessG")] [SerializeField] private float sunsetSharpnessG = 1.0f;

		/// <summary>The sharpness of the sunset blue channel transition.</summary>
		public float SunsetSharpnessB { set { if (sunsetSharpnessB != value) { sunsetSharpnessB = value; UpdateTexture(); } } get { return sunsetSharpnessB; } } [FSA("SunsetSharpnessB")] [SerializeField] private float sunsetSharpnessB = 1.0f;
	...
	public class SgtJovianScatteringTex_Editor : SgtEditor<SgtJovianScatteringTex>
	{
		protected override void OnInspector()
		{
			BeginError(Any(t => t.Width <= 1));
				Draw("width", "The resolution of the day/sunset/night color transition in pixels. A higher value can result in smoother results.");
			EndError();
			BeginError(Any(t => t.Height <= 1));
				Draw("height", "The resolution of the scattering transition in pixels.");
			EndError();
			...
			BeginError(Any(t => t.Mie < 1.0f));
				Draw("mie", "The sharpness of the forward scattered light.");
			EndError();
			BeginError(Any(t => t.Rayleigh < 0.0f));
				Draw("rayleigh", "The brightness of the front and back scattered light.");
			EndError();

			Separator();

			Draw("sunsetEase", "The transition style between the day and night.");
			BeginError(Any(t => t.SunsetStart >= t.SunsetEnd));
				Draw("sunsetStart", "The start point of the sunset (0 = dark side, 1 = light side).");
				Draw("sunsetEnd", "The end point of the sunset (0 = dark side, 1 = light side).");
			EndError();
			Draw("sunsetSharpnessR", "The sharpness of the sunset red channel transition.");
			Draw("sunsetSharpnessG", "The sharpness of the sunset green channel transition.");
			Draw("sunsetSharpnessB", "The sharpness of the sunset blue channel transition.");
		}
	}
}
#endif