	...
	public class SgtPlanet_Editor : SgtEditor<SgtPlanet>
	{
		protected override void OnInspector()
		{
			...
			BeginError(Any(t => t.Mesh == null));
				Draw("mesh", ref rebuild, "The sphere mesh used to render the planet.");
			EndError();
			Draw("meshCollider", ref rebuild, "If you want the generated mesh to have a matching collider, you can specify it here.");
			BeginError(Any(t => t.Radius <= 0.0f));
				Draw("radius", ref rebuild, "The radius of the planet in local space.");
			EndError();
			...
			Draw("heightmap", ref rebuild, "The heightmap texture, where the height data is stored in the alpha channel.\n\nNOTE: This should use an Equirectangular projection.\n\nNOTE: This texture should be marked as readable.");
			BeginError(Any(t => t.Displacement == 0.0f));
				Draw("displacement", ref rebuild, "The maximum height displacement applied to the planet mesh when the heightmap alpha value is 1.");
			EndError();
			Draw("waterLevel", ref rebuild, "The current water level.\n\n0 = Radius.\n\n1 = Radius + Displacement.");
			Draw("clampWater", ref rebuild, "If you enable this then the water will not rise, instead the terrain will shrink down.");
