...
namespace SpaceGraphicsToolkit
{
	public class SgtTerrainCube
	{
		...
		public SgtTerrainCube(SgtTerrain newTerrain)
		{
			...
			quads[0] = new SgtTerrainQuad(this, 0, 0.0, SgtTerrainTopology.CubeC[0], SgtTerrainTopology.CubeH[0], SgtTerrainTopology.CubeV[0]);
			quads[1] = new SgtTerrainQuad(this, 1, 0.5, SgtTerrainTopology.CubeC[1], SgtTerrainTopology.CubeH[1], SgtTerrainTopology.CubeV[1]);
			quads[2] = new SgtTerrainQuad(this, 2, 0.0, SgtTerrainTopology.CubeC[2], SgtTerrainTopology.CubeH[2], SgtTerrainTopology.CubeV[2]);
			quads[3] = new SgtTerrainQuad(this, 3, 0.5, SgtTerrainTopology.CubeC[3], SgtTerrainTopology.CubeH[3], SgtTerrainTopology.CubeV[3]);
			quads[4] = new SgtTerrainQuad(this, 4, 0.0, SgtTerrainTopology.CubeC[4], SgtTerrainTopology.CubeH[4], SgtTerrainTopology.CubeV[4]);
