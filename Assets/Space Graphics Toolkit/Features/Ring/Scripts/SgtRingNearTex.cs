...
namespace SpaceGraphicsToolkit
{
	...
	public class SgtRingNearTex : MonoBehaviour
	{
		...
		public TextureFormat Format { set { if (format != value) { format = value; UpdateTexture(); } } get { return format; } } [FSA("Format")] [SerializeField] private TextureFormat format = TextureFormat.Alpha8;
