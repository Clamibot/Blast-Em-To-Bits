...
namespace SpaceGraphicsToolkit
{
	...
	public class SgtRingMainTexFilter : MonoBehaviour
	{
		...
		public Texture2D Source { set { if (source != value) { source = value; UpdateTexture(); } } get { return source; } } [FSA("Source")] [SerializeField] private Texture2D source;
		...
		public float Power { set { if (power != value) { power = value; UpdateTexture(); } } get { return power; } } [FSA("Power")] [SerializeField] private float power = 0.5f;

		/// <summary>This allows you to control the brightness.</summary>
		public float Exposure { set { if (exposure != value) { exposure = value; UpdateTexture(); } } get { return exposure; } } [FSA("Exposure")] [SerializeField] [Range(-1.0f, 1.0f)] private float exposure = 0.0f;
	...
	public class SgtRingMainTexFilter_Editor : SgtEditor<SgtRingMainTexFilter>
	{
		protected override void OnInspector()
		{
			BeginError(Any(t => t.Source == null));
				Draw("source", "The source ring texture that will be filtered.");
			EndError();
			...
			BeginError(Any(t => t.Power < 0.0f));
				Draw("power", "The sharpness of the light/dark transition.");
			EndError();
			Draw("exposure", "This allows you to control the brightness.");
		}
	}
}
#endif