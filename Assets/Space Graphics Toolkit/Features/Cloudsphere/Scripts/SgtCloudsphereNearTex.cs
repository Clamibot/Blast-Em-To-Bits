...
namespace SpaceGraphicsToolkit
{
	...
	public class SgtCloudsphereNearTex : MonoBehaviour
	{
		...
		public SgtEase.Type Ease { set { if (ease != value) { ease = value; UpdateTexture(); } } get { return ease; } } [FSA("Ease")] [SerializeField] private SgtEase.Type ease = SgtEase.Type.Smoothstep;

		/// <summary>The sharpness of the transition.</summary>
		public float Sharpness { set { if (sharpness != value) { sharpness = value; UpdateTexture(); } } get { return sharpness; } } [FSA("Sharpness")] [SerializeField] private float sharpness = 1.0f;

		/// <summary>The start point of the fading.</summary>
		public float Offset { set { if (offset != value) { offset = value; UpdateTexture(); } } get { return offset; } } [FSA("Offset")] [SerializeField] [Range(0.0f, 1.0f)] private float offset;
...
namespace SpaceGraphicsToolkit
{
	...
	public class SgtCloudsphereNearTex_Editor : SgtEditor<SgtCloudsphereNearTex>
	{
		protected override void OnInspector()
		{
			...
			Draw("ease", "The ease type used for the transition.");
			Draw("sharpness", "The sharpness of the transition.");
			BeginError(Any(t => t.Offset >= 1.0f));
				Draw("offset", "The start point of the fading.");
			EndError();
		}
	}
}
