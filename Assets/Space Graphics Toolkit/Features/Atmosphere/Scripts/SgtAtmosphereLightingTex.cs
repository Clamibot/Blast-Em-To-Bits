...
namespace SpaceGraphicsToolkit
{
	...
	public class SgtAtmosphereLightingTex : MonoBehaviour
	{
		...
		public float SunsetStart { set { if (sunsetStart != value) { sunsetStart = value; UpdateTexture(); } } get { return sunsetStart; } } [FSA("SunsetStart")] [Range(0.0f, 1.0f)] [SerializeField] private float sunsetStart = 0.45f;

		/// <summary>The end point of the sunset/night transition (0 = dark side, 1 = light side).</summary>
		public float SunsetEnd { set { if (sunsetEnd != value) { sunsetEnd = value; UpdateTexture(); } } get { return sunsetEnd; } } [FSA("SunsetEnd")] [Range(0.0f, 1.0f)] [SerializeField] private float sunsetEnd = 1.0f;

		/// <summary>The sharpness of the sunset red channel transition.</summary>
		public float SunsetSharpnessR { set { if (sunsetSharpnessR != value) { sunsetSharpnessR = value; UpdateTexture(); } } get { return sunsetSharpnessR; } } [FSA("SunsetSharpnessR")] [SerializeField] private float sunsetSharpnessR = 3.0f;
