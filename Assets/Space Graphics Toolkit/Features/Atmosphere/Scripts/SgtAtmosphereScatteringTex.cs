...
namespace SpaceGraphicsToolkit
{
	...
	public class SgtAtmosphereScatteringTex : MonoBehaviour
	{
		...
		public float SunsetStart { set { if (sunsetStart != value) { sunsetStart = value; UpdateTexture(); } } get { return sunsetStart; } } [FSA("SunsetStart")] [Range(0.0f, 1.0f)] [SerializeField] private float sunsetStart = 0.35f;

		/// <summary>The end point of the sunset/night transition (0 = dark side, 1 = light side).</summary>
		public float SunsetEnd { set { if (sunsetEnd != value) { sunsetEnd = value; UpdateTexture(); } } get { return sunsetEnd; } } [FSA("SunsetEnd")] [Range(0.0f, 1.0f)] [SerializeField] private float sunsetEnd = 0.6f;

		/// <summary>The sharpness of the sunset red channel transition.</summary>
		public float SunsetSharpnessR { set { if (sunsetSharpnessR != value) { sunsetSharpnessR = value; UpdateTexture(); } } get { return sunsetSharpnessR; } } [FSA("SunsetSharpnessR")] [SerializeField] private float sunsetSharpnessR = 2.0f;

		/// <summary>The sharpness of the sunset green channel transition.</summary>
		public float SunsetSharpnessG { set { if (sunsetSharpnessG != value) { sunsetSharpnessG = value; UpdateTexture(); } } get { return sunsetSharpnessG; } } [FSA("SunsetSharpnessG")] [SerializeField] private float sunsetSharpnessG = 2.0f;

		/// <summary>The sharpness of the sunset blue channel transition.</summary>
		public float SunsetSharpnessB { set { if (sunsetSharpnessB != value) { sunsetSharpnessB = value; UpdateTexture(); } } get { return sunsetSharpnessB; } } [FSA("SunsetSharpnessB")] [SerializeField] private float sunsetSharpnessB = 2.0f;
	...
	public class SgtAtmosphereScatteringTex_Editor : SgtEditor<SgtAtmosphereScatteringTex>
	{
		protected override void OnInspector()
		{
			...
			BeginError(Any(t => t.SunsetStart >= t.SunsetEnd));
				Draw("sunsetStart", "The start point of the day/sunset transition (0 = dark side, 1 = light side).");
				Draw("sunsetEnd", "The end point of the sunset/night transition (0 = dark side, 1 = light side).");
			EndError();
