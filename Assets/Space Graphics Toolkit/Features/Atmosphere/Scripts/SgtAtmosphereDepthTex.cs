...
namespace SpaceGraphicsToolkit
{
	...
	public class SgtAtmosphereDepthTex : MonoBehaviour
	{
		...
		public int Width { set { if (width != value) { width = value; UpdateTextures(); } } get { return width; } } [FSA("Width")] [SerializeField] private int width = 256;
		...
		public Color HorizonColor { set { if (horizonColor != value) { horizonColor = value; UpdateTextures(); } } get { return horizonColor; } } [FSA("HorizonColor")] [SerializeField] private Color horizonColor = Color.white;

		/// <summary>The base color of the inner texture.</summary>
		public Color InnerColor { set { if (innerColor != value) { innerColor = value; UpdateTextures(); } } get { return innerColor; } } [FSA("InnerColor")] [SerializeField] private Color innerColor = new Color(0.15f, 0.54f, 1.0f);
		...
		public float InnerColorSharpness { set { if (innerColorSharpness != value) { innerColorSharpness = value; UpdateTextures(); } } get { return innerColorSharpness; } } [FSA("InnerColorSharpness")] [SerializeField] private float innerColorSharpness = 2.0f;

		/// <summary>The strength of the inner texture transition.</summary>
		public float InnerAlphaSharpness { set { if (innerAlphaSharpness != value) { innerAlphaSharpness = value; UpdateTextures(); } } get { return innerAlphaSharpness; } } [FSA("InnerAlphaSharpness")] [SerializeField] private float innerAlphaSharpness = 3.0f;

		/// <summary>The base color of the outer texture.</summary>
		public Color OuterColor { set { if (outerColor != value) { outerColor = value; UpdateTextures(); } } get { return outerColor; } } [FSA("OuterColor")] [SerializeField] private Color outerColor = new Color(0.29f, 0.73f, 1.0f);
		...
		public float OuterColorSharpness { set { if (outerColorSharpness != value) { outerColorSharpness = value; UpdateTextures(); } } get { return outerColorSharpness; } } [FSA("OuterColorSharpness")] [SerializeField] private float outerColorSharpness = 2.0f;

		/// <summary>The strength of the outer texture transition.</summary>
		public float OuterAlphaSharpness { set { if (outerAlphaSharpness != value) { outerAlphaSharpness = value; UpdateTextures(); } } get { return outerAlphaSharpness; } } [FSA("OuterAlphaSharpness")] [SerializeField] private float outerAlphaSharpness = 3.0f;
...
namespace SpaceGraphicsToolkit
{
	...
	public class SgtAtmosphereDepthTex_Editor : SgtEditor<SgtAtmosphereDepthTex>
	{
		protected override void OnInspector()
		{
			...
			Draw("horizonColor", "This allows you to set the color that appears on the horizon.");
